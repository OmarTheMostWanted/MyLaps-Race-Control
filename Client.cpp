...
void Client::sendRawSocket(const std::string &data) {
...
void Client::readRawSocket(std::string &response, const std::regex &responsePattern, unsigned int timeoutSeconds) {
